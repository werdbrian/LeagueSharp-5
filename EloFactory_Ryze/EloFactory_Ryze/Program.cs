    ...
    internal class Program
    {
        ...
        public static void LastHit()
        {
            ...
            if (useW && W.IsReady())
            {
                ...
                if (Player.GetAutoAttackDamage(MinionQ) < MinionQ.Health && Player.ManaPercent > MinManaW && Player.Distance(MinionQ) <= W.Range && MinionQ.Health < W.GetDamage(MinionQ) && MinionQ.Health < W.GetDamage(MinionQ) * 0.8)
                {
            ...
            if (useE && E.IsReady())
            {
                ...
                if (Player.GetAutoAttackDamage(MinionQ) < MinionQ.Health && Player.ManaPercent > MinManaE && Player.Distance(MinionQ) <= E.Range && MinionQ.Health < E.GetDamage(MinionQ) * 0.8)
                {
                    E.Cast(MinionQ, true);
                }
            ...
            if (useQ && Q.IsReady())
            {
                ...
                {
                    if (Player.GetAutoAttackDamage(MinionQ) < MinionQ.Health && Player.ManaPercent > MinManaQ && minion.Health < Q.GetDamage(minion) * 0.8)
                    {
        ...
        public static void LaneClear()
        {
            ...
            if (useW && W.IsReady())
            {
                ...
                if (Player.GetAutoAttackDamage(MinionQ) < MinionQ.Health && Player.ManaPercent > MinManaW && Player.Distance(MinionQ) <= W.Range && MinionQ.Health < W.GetDamage(MinionQ) * 0.8)
                {
            ...
            if (useE && E.IsReady())
            {
                ...
                if (Player.GetAutoAttackDamage(MinionQ) < MinionQ.Health && Player.ManaPercent > MinManaE && Player.Distance(MinionQ) <= E.Range)
                {
                    E.Cast(MinionQ, true);
                }
